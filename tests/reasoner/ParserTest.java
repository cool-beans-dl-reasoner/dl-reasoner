...
public class ParserTest {
  ...
  public void BritishgotoBar() {
    ...
    parser.parseExpression("John subset rich union not poor");
    parser.parseExpression("British subset exists goto dot school");
    parser.parseExpression("John subset British");

    SubsumptionEquivalence query = parser.parseQuery("John subset exists goto dot school");
...
//
//  @Test
//  public void testMadCowExample() {
//    Parser parser = new Parser();
//    parser.parseExpression("cow equivalent animal intersect vegetarian");
//    parser.parseExpression("sheep subset animal");
//    parser.parseExpression("vegetarian equivalent exists eats dot not animal");
//    parser.parseExpression("madcow equivalent cow intersect eats dot sheep intersect lessthanorequalto 1 dot eats");
//
//    SubsumptionEquivalence query = parser.parseQuery("madcow subset eats dot sheep");
//    Reasoner reasoner = new Reasoner(parser.getTBox(), query);
//    assertTrue(reasoner.queryIsValid());
//  }
//
